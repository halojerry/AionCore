...
## [0.1.30](https://github.com/halojerry/AionCore/compare/v0.1.29...v0.1.30) (2026-07-01)
...
* **acp:** backport config-options endpoint with POUNDING ActiveAgentNotFound handling ([1ee1378](https://github.com/halojerry/AionCore/commit/1ee1378d54f15d3dca6ed00a078da8a16d65f6b6))
* **acp:** dead ACP connection recovery — phase tracking + guards + eviction ([887c225](https://github.com/halojerry/AionCore/commit/887c225125a18759040b4ce245f142a7bc6cc945))
* **acp:** inject OPENCODE_CONFIG for OpenCode, OPENCLAW env vars for OpenClaw ([4d88d26](https://github.com/halojerry/AionCore/commit/4d88d26d86a593b13a9f7e12291fd0d9d5a31406))
* **acp:** use observed config options for preferences ([#468](https://github.com/halojerry/AionCore/issues/468)) ([fd2d5c2](https://github.com/halojerry/AionCore/commit/fd2d5c2db10e80dc478ee88c2d1f787e91015eb1))
...
* add 3 new builtin assistants (teacher, getnote, xiaohongshu-creator) ([28e535a](https://github.com/halojerry/AionCore/commit/28e535a2517c79c8c29fc8c94d9e4d968ee26312))
* add GET/PUT /api/settings/managed-runtime endpoint ([9e5d1a4](https://github.com/halojerry/AionCore/commit/9e5d1a45b9e4ce6e395537f35d1decb19a8fc3cb))
...
* add pounding serde alias for ConversationSource ([9a41a59](https://github.com/halojerry/AionCore/commit/9a41a591395cd794500d189c0ea4ca5e57dbcdcf))
...
* **auth:** add NewApi login endpoint for WebUI ([e4aa3d7](https://github.com/halojerry/AionCore/commit/e4aa3d7dc933441bfdb6578d3bf265623d10d9fa))
...
* cc-switch unified 5-CLI config + model switch fix + ozon skill updates ([2739f94](https://github.com/halojerry/AionCore/commit/2739f948cba8802f25445422e02a473b8234c658))
* **ci:** bundle managed CLI resources (node,acp,native) in release ([dddc8f8](https://github.com/halojerry/AionCore/commit/dddc8f8a12cc1a33304f7aed5b3f2f744af946b5))
...
* integrate 45 builtin assistants + 170 skills + 47 avatars + 156 rules ([7072069](https://github.com/halojerry/AionCore/commit/7072069bf86a6616e3dc5eb4b15e811420724be9))
* **lark:** add Lark/Feishu builtin assistant with 27 skills ([a47a2a4](https://github.com/halojerry/AionCore/commit/a47a2a452fc426f6b302b483382ce4c164061f7c))
...
* **mcp:** add Chrome DevTools as builtin MCP server for all agents ([e9462c1](https://github.com/halojerry/AionCore/commit/e9462c122828ad8dfc7b3bc6401cab808137c1e4))
...
* **mcp:** wire Image Generation MCP into ACP sessions ([dff9c2a](https://github.com/halojerry/AionCore/commit/dff9c2a2cd7d622014d35ec66691f834d03db65e))
* **ozon:** bump skill to v0.7.0 — add search, probe, fix-prices commands ([a3df382](https://github.com/halojerry/AionCore/commit/a3df382e1268fdd773b84fc1b928482cf3972b2c))
* register pounding-expert and social-cover-design builtin assistants ([c17bc8e](https://github.com/halojerry/AionCore/commit/c17bc8e784c1dd37bc4e0efc3d8b9d1638535ea6))
...
* AC-1 + AC-2 — shutdown grace period + non-fatal persistence ([114b384](https://github.com/halojerry/AionCore/commit/114b3843925e6941d9a29901288d7db21d0b9dd7))
* **acp:** add warning logs when OpenClaw config/token cannot be read ([f947996](https://github.com/halojerry/AionCore/commit/f947996c0df7f5ce2e5c70d36ecfffeee191923f))
...
* **acp:** config_not_observed fix + MCP diagnostics + cargo fmt ([#19](https://github.com/halojerry/AionCore/issues/19)) ([76ada73](https://github.com/halojerry/AionCore/commit/76ada73421486a02b0d42bbcb93537c11d69cd07))
...
* **acp:** redirect config-options model/mode to working endpoints ([67e918c](https://github.com/halojerry/AionCore/commit/67e918cd0a8767cf00315d6a446b8500681cd779))
...
* **agent:** send non-empty clientInfo in ACP initialize handshake ([#471](https://github.com/halojerry/AionCore/issues/471)) ([7ea1f8e](https://github.com/halojerry/AionCore/commit/7ea1f8ef28c0e22d147fcc471b3c8f5a2ac905d3))
...
* **agent:** wait for task shutdown during clear ([#446](https://github.com/halojerry/AionCore/issues/446)) ([bea814e](https://github.com/halojerry/AionCore/commit/bea814e08ddb96ccb5d09a8016e92d179a2f318a))
...
* AIONCORE_LISTENING → POUNDINGCORE_LISTENING ([41a2922](https://github.com/halojerry/AionCore/commit/41a292284662510193f68de708ac7a7d11e22c10))
...
* bump codex-acp from 0.14.0 to 0.16.0 to fix release smoke test ([b50f29c](https://github.com/halojerry/AionCore/commit/b50f29c93a193ca8b9ed41d12c81755e4da582ec))
* canonicalize bundle_out path + update stale OpenClaw test ([6380a32](https://github.com/halojerry/AionCore/commit/6380a320bc7ec7b7022dc258b6a2193f4b971f76))
...
* **cc-switch:** add skip-if-complete to ensure_openclaw_live_config(); fix QR HTML qrToken→qr_token ([3c69f2f](https://github.com/halojerry/AionCore/commit/3c69f2f7580cd3c9f1ef87d4be647a1d01ef1855))
* **cc-switch:** handle legacy Codex provider config TOML format ([339e1e6](https://github.com/halojerry/AionCore/commit/339e1e618c1e18481231c5e0302fcc01f06ba761))
* change native-cli download URL from pounding to poundingcore ([d9d2bde](https://github.com/halojerry/AionCore/commit/d9d2bde6e30234b1fb0828b3fe86b22c695f9f66))
...
* **ci:** aioncore→poundingcore binary name, add feature branch triggers, update release-please ([8e13658](https://github.com/halojerry/AionCore/commit/8e13658e73d4071b5e7719773c1c732a51287db6))
...
* **ci:** audit-check@v3→[@v2](https://github.com/v2), broaden branch trigger to feature/** ([5758046](https://github.com/halojerry/AionCore/commit/575804609ded100fc16351c10de4a4997f27fab2))
...
* **ci:** prevent infinite -Pounding suffix loop in release workflow ([f23f3e8](https://github.com/halojerry/AionCore/commit/f23f3e894c8f671e057d65bf1896e5a4b3d47b40))
* **ci:** remove AIONCORE_ALLOW_MAIN_MIGRATION_EDIT bypass ([243f644](https://github.com/halojerry/AionCore/commit/243f644c5fb364bf0d4c07e5b79ccec4291a05ed))
...
* clippy manual_unwrap_or_default in connection_test protocol ([028ce15](https://github.com/halojerry/AionCore/commit/028ce152b581f855be2b010cbf73d80c5a7a6b39))
* co-locate npm config on staging drive to fix Windows EISDIR ([6edd7c6](https://github.com/halojerry/AionCore/commit/6edd7c6ee86bdbd7518621d07a25cd1835de8f67))
* code review fixes — regex optimization + test cleanup ([8a4a47e](https://github.com/halojerry/AionCore/commit/8a4a47ef032723831b33e97b6497f6a75f52b3ed))
...
* **conversation:** return 404 for nonexistent conversation in get_slash_commands, get/set_config_options ([01d2346](https://github.com/halojerry/AionCore/commit/01d234633490aa618d0426f0cf7edd3b388251ce))
* **conversation:** return 404 for set_model on nonexistent conversation ([82f398f](https://github.com/halojerry/AionCore/commit/82f398fe9dcbc06a438f107bfa1beb62f2fb4000))
...
* **db:** remove duplicate migration 010_add_pounding_cli.sql (replaced by 013) ([8bc19aa](https://github.com/halojerry/AionCore/commit/8bc19aac828a57de5d0c95f5b93cd82fe1b62fc1))
* **db:** rename 010_add_pounding_cli.sql → 015 to resolve migration version conflict ([2ebedda](https://github.com/halojerry/AionCore/commit/2ebedda406db1502b14ddb00e1682967e1f33a52))
...
* defend against npm packages with broken exports/main paths in smoke test ([3822757](https://github.com/halojerry/AionCore/commit/38227579c686c370681602ae38dd18323bb7a71c))
...
* extend CC-Switch model/env injection to Hermes backend ([c3da25c](https://github.com/halojerry/AionCore/commit/c3da25cac1b83745c0960bbe7bda37fa4147bab5))
...
* final clippy::collapsible_if fix + cargo fmt --all ([021023c](https://github.com/halojerry/AionCore/commit/021023ca6a8ccce51888fe3ea18cc7a19021e16b))
* final clippy::collapsible_if fix + cargo fmt --all ([9b79932](https://github.com/halojerry/AionCore/commit/9b79932d9b2fdcd26c3d02f968930dcb45416837))
* final clippy::collapsible_if fix + cargo fmt --all ([e61f1e6](https://github.com/halojerry/AionCore/commit/e61f1e638bcf043f73677b7872b181e3495ede4b))
* final clippy::collapsible_if fix + cargo fmt --all ([b52c94c](https://github.com/halojerry/AionCore/commit/b52c94c01d0126bead96f88743d11ce6a8d6bd53))
* final clippy::collapsible_if fix + cargo fmt --all ([f466445](https://github.com/halojerry/AionCore/commit/f466445fe869a4be5b17bfc477aeb1ebab87fe97))
* final clippy::collapsible_if fix + cargo fmt --all ([bc70a90](https://github.com/halojerry/AionCore/commit/bc70a90ded709b6544a7ef0c1b1e458e58225e04))
* handle absolute bin paths in smoke test (codex-acp) ([7196b02](https://github.com/halojerry/AionCore/commit/7196b02255f5caa844941806f808e5bbea67604b))
...
* improve OpenClaw diagnostics + Codex session rebuild logging ([004f230](https://github.com/halojerry/AionCore/commit/004f2309c8d64d22454c7fb0a2318d554c5e1275))
* increase idle timeout to 15min + inject OpenClaw env vars in generic spawn path ([d1f53e2](https://github.com/halojerry/AionCore/commit/d1f53e299645fa15c1a4734b7bf1d16991d2fea1))
...
* make cancel endpoint accept optional turn_id to prevent 400 errors ([c0a4b70](https://github.com/halojerry/AionCore/commit/c0a4b7030ed74cbec58d7f115d05bdf00f3db9e6))
* make native CLI preparation non-fatal in Release CI ([4f6175f](https://github.com/halojerry/AionCore/commit/4f6175f7c4bc7d85784deeeed0fc48dc54f017a9))
* make smoke test non-fatal (EISDIR on Windows node --check) ([5964962](https://github.com/halojerry/AionCore/commit/596496288498d7fdc7c131702663be351c1ce699))
...
* missing tempfile:: prefix on tempdir() call ([7e7ba4a](https://github.com/halojerry/AionCore/commit/7e7ba4abcdcb64c53eeecdde0219f3f391bb41cc))
...
* **office:** fetch officecli installer from official mirror before GitHub ([#463](https://github.com/halojerry/AionCore/issues/463)) ([08fbc6f](https://github.com/halojerry/AionCore/commit/08fbc6f12d154d5419ae1b092a1a9352ee64250e))
...
* QR login query-param fallback + clippy fixes ([39a3c05](https://github.com/halojerry/AionCore/commit/39a3c0502af1c7f566230abf99101a7ba8fd12db))
* QR login query-param fallback + clippy fixes ([24ff0e5](https://github.com/halojerry/AionCore/commit/24ff0e5ce8bdea7ab3687eba951afc5a6e753104))
...
* refactor npm config into NpmConfig struct to fix clippy too_many_arguments ([db6dbc1](https://github.com/halojerry/AionCore/commit/db6dbc1df43a9d5148404dae236ae1bf81f87d3c))
...
* rename DB aionui-backend.db → pounding-backend.db, accept numeric user.id ([1d8ca3f](https://github.com/halojerry/AionCore/commit/1d8ca3f839ca130767acb6ed5232c1fb150f6b09))
...
* restore full repo tree after accidental deletion ([15e7d8e](https://github.com/halojerry/AionCore/commit/15e7d8e6616663c17f5d28684e8bf1ae6e4a32dd))
...
* robust smoke test path resolution + conversation existence check for get_model ([9f5a117](https://github.com/halojerry/AionCore/commit/9f5a117a411c7c41e63616ec54d01eb2dfc1dedf))
...
* **shell:** reveal file via FileManager1 D-Bus on Linux ([#466](https://github.com/halojerry/AionCore/issues/466)) ([98c75ec](https://github.com/halojerry/AionCore/commit/98c75ecc1bf20263f9bb682d8729d0924060f178))
...
* skip npm packages with absolute main/exports paths in smoke test ([115320d](https://github.com/halojerry/AionCore/commit/115320d9ed1c6c4a6ddad75152eae021dc686684))
...
* **test:** update avatar test after fixing word-form-creator emoji avatar ([df952d6](https://github.com/halojerry/AionCore/commit/df952d62664d9efd54a0d32e2fa1caa845fa6e50))
...
* update branding skill path and suppress managed-runtime 404 ([8b455a6](https://github.com/halojerry/AionCore/commit/8b455a630e07168f7458a6d6453eb86245be4007))
* update check-branding.sh for renamed migration and skill paths ([13258ea](https://github.com/halojerry/AionCore/commit/13258eaf2112323de2c4fab2079799c003daf6eb))
...
* update smoke test to create actual file for entrypoint check ([7759177](https://github.com/halojerry/AionCore/commit/775917795962fcec2826c71cbee9c90080341ad3))
...
* use Path::is_absolute() instead of starts_with('/') for Windows smoke test ([4ab7e7c](https://github.com/halojerry/AionCore/commit/4ab7e7c03bdf8dcbcbafe3fba1a1bb904e41a63c))
* use temp_dir() for bundle staging to avoid Windows MAX_PATH ([e04fd5a](https://github.com/halojerry/AionCore/commit/e04fd5acdb2b8dcc47b919cdaabd29f885466637))
...
* **auth:** replace newapi-login proxy with sync-credentials endpoint ([3504545](https://github.com/halojerry/AionCore/commit/350454581fc6e855e30052f829835d77eff2afa0))
